...
public class AboutTab extends ScrollPane
{
    ...
    public AboutTab(final ClientListener clientListener) {
        ...
        final Label versionText = new Label(invokedynamic(makeConcatWithConstants:(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;, clientInfo.getVersion().getText(), clientInfo.getPlatform().getUIName(), clientInfo.getReleaseStatus().getUIName()));
        versionText.getStyleClass().add((Object)"about_version_label");
        final Label commStandardLabel = new Label(invokedynamic(makeConcatWithConstants:(Ljava/lang/String;)Ljava/lang/String;, clientInfo.getCommStandardVersion().getText()));
        commStandardLabel.getStyleClass().add((Object)"about_comm_standard_label");
        final Label minThemeAPILabel = new Label(invokedynamic(makeConcatWithConstants:(Ljava/lang/String;)Ljava/lang/String;, clientInfo.getMinThemeSupportVersion().getText()));
        minThemeAPILabel.getStyleClass().add((Object)"about_min_theme_api_label");
        final Label minActionAPILabel = new Label(invokedynamic(makeConcatWithConstants:(Ljava/lang/String;)Ljava/lang/String;, clientInfo.getMinPluginSupportVersion().getText()));
        minActionAPILabel.getStyleClass().add((Object)"about_min_action_api_label");
        final Label currentActionAPILabel = new Label(invokedynamic(makeConcatWithConstants:(Ljava/lang/String;)Ljava/lang/String;, ActionAPI.API_VERSION.getText()));
        ...
        final Label javaVersionLabel = new Label(invokedynamic(makeConcatWithConstants:(Ljava/lang/String;)Ljava/lang/String;, System.getProperty("java.version")));
        javaVersionLabel.getStyleClass().add((Object)"about_java_version");
        final Label javafxVersionLabel = new Label(invokedynamic(makeConcatWithConstants:(Ljava/lang/String;)Ljava/lang/String;, System.getProperty("javafx.version")));
        javafxVersionLabel.getStyleClass().add((Object)"about_javafx_version");
        final Label javaGCLabel = new Label(invokedynamic(makeConcatWithConstants:(Ljava/lang/String;)Ljava/lang/String;, ManagementFactory.getGarbageCollectorMXBeans().get(0).getName()));
        ...
        if (inputStream != null) {
            try {
                ...
                final Label buildDateLabel = new Label(invokedynamic(makeConcatWithConstants:(Ljava/lang/String;)Ljava/lang/String;, new String(inputStream.readAllBytes())));
